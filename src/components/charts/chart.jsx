...
import { Chart as ChartJS, CategoryScale, LinearScale, PointElement, LineElement, Title, Tooltip, Legend, Bar, BarElement, } from 'chart.js/auto';
...
const MultiAxisLineChart = () => {
  ...
  return (
    <Box aligItems={"center"} sx={{minWidth: "37vw", maxWidth: "35vw", minHeight: "40vh", maxHeight: "30vh"}} >
