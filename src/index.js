...
import ProtectedRoute from "./components/login-profile/componenteProtegido";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/instalacao", element: <TableInstalacao /> },
      { path: "/manutencao", element: <TableManutencao /> },
      { path: "/boletosbaixa", element: <TableBoletos /> },
      { path: "/cancelamento", element: <TableCancelamento /> },
      { path: "/mudarplano", element: <TablePlano /> },
      { path: "/mudartitular", element: <TableTitular /> },
      { path: "/config", element: <JoyOrderDashboardTemplate /> },
    ],
  },
  {
    path: "/entrar",
